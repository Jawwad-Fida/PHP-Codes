...
$post_data['ship_name'] = "testfidalyk5v"; //store name
...
$post_data['vat'] = "500"; //vat on goods
...
$post_data["product_category"] = isset($_POST['product_category']) ? $_POST['product_category'] : "Electronic";
...
$post_data["product_profile"] = isset($_POST['product_profile']) ? $_POST['product_profile'] : "01711111111";
